...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="h-screen bg-gray-400 flex flex-col items-center justify-center">
        ...
        <form id="form" action="/create" method="POST" class="flex flex-col">
            @csrf
            <label for="name">Nombre</label>
            <input type="text" name="name" id="name" maxlength="30" placeholder="Introduce el nombre del documento">
            ...
            <textarea id="description" name="description" cols="100" rows="6" maxlength="300" placeholder="Introduce una descripción del documento"></textarea>
